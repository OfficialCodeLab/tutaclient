...
tuta.forms.frmMap = function() {
  ...
  tuta.forms.frmMap.onPreShow = function(form) {
    ...
    this.control("txtDest").onTextChange = function() {
      if(frmMap.txtDest.text === "" || frmMap.txtDest.text === null)
        frmMap.Image066d5e18d311e4b.setVisibility(false);
      else
        frmMap.Image066d5e18d311e4b.setVisibility(true);
    };

    this.control("txtPick").onTextChange = function() {
      if(frmMap.txtPick.text === "" || frmMap.txtPick.text === null)
